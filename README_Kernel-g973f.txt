...
1. Download and unzip the kernel source of G973FXXU4CTC9.

2. Unzip and update the kernel source of G973FXXS5CTD1.
...
3. How to Build
        ...
        - edit Makefile
                ...
                edit "CLANG" to right path(You downloaded).
                        EX)  CC=<android platform directory you download>/android/prebuilts/clang/host/linux-x86/clang-4639204-cfp-jopp/bin/clang
